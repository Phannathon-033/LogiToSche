...
export const initialJson: JsonSchemaOutput = {
  ...
  sender: "ABC Logistics Co., Ltd.",
  receiver: "XYZ Importer Co., Ltd.",
  origin: "Bang Phli, Samut Prakan",
  destination: "Mueang Chonburi, Chonburi",
...
export const initialFields: ExtractedField[] = [
  ...
  { id: 2, sourceText: "INV-2024-001", field: "document_number", value: "INV-2024-001", confidence: 98, status: "success" },
  { id: 3, sourceText: "15/05/2024", field: "document_date", value: "2024-05-15", confidence: 97, status: "success" },
  { id: 4, sourceText: "ABC Logistics Co., Ltd.", field: "sender", value: "ABC Logistics Co., Ltd.", confidence: 96, status: "success" },
  { id: 5, sourceText: "XYZ Importer Co., Ltd.", field: "receiver", value: "XYZ Importer Co., Ltd.", confidence: 96, status: "success" },
  { id: 6, sourceText: "70-1234", field: "truck_plate", value: "70-1234", confidence: 78, status: "review", isOther: true },
  { id: 7, sourceText: "25,000 KG", field: "gross_weight_kg", value: "25000", confidence: 85, status: "review", isOther: true },
  { id: 8, sourceText: "120", field: "quantity", value: "120", confidence: 96, status: "success", isOther: true },
  { id: 9, sourceText: "48,750.00 THB", field: "total_amount", value: "48750", confidence: 99, status: "success" },
  { id: 10, sourceText: "THB", field: "currency", value: "THB", confidence: 99, status: "success" },
];
...
Port of Discharge: Singapore`,
    jsonOutput: {
      ...
      sender: "Meridian Shipping",
      receiver: "",
      origin: "Laem Chabang",
      destination: "Singapore",
      reference_number: "BL-2025-018",
      unit_price: 0,
      total_amount: 0,
      currency: "",
...
Total Amount: unreadable`,
    jsonOutput: {
      ...
      document_number: "PK-2025-003",
      document_date: "2025-08-26",
      sender: "",
      receiver: "",
      origin: "",
      destination: "",
      reference_number: "PK-2025-003",
      unit_price: 0,
      total_amount: 0,
      currency: "",
